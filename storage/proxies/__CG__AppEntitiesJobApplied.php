 ...
 */
class JobApplied extends \App\Entities\JobApplied implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entities\\JobApplied' . "\0" . 'id', '' . "\0" . 'App\\Entities\\JobApplied' . "\0" . 'jobPostedId', '' . "\0" . 'App\\Entities\\JobApplied' . "\0" . 'resume', '' . "\0" . 'App\\Entities\\JobApplied' . "\0" . 'userId', '' . "\0" . 'App\\Entities\\JobApplied' . "\0" . 'remarks', '' . "\0" . 'App\\Entities\\JobApplied' . "\0" . 'isActive', 'createdAt', 'updatedAt'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (JobApplied $proxy) {
    ...
    public function getJobPostedId(): string
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getJobPostedId', []);

        return parent::getJobPostedId();
    }
    ...
    public function setJobPostedId(string $jobPostedId): void
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setJobPostedId', [$jobPostedId]);

        parent::setJobPostedId($jobPostedId);
    }
