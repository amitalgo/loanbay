 ...
 */
class JobType extends \App\Entities\JobType implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entities\\JobType' . "\0" . 'id', '' . "\0" . 'App\\Entities\\JobType' . "\0" . 'jobType', '' . "\0" . 'App\\Entities\\JobType' . "\0" . 'isActive', 'createdAt', 'updatedAt', '' . "\0" . 'App\\Entities\\JobType' . "\0" . 'JobPosted'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (JobType $proxy) {
