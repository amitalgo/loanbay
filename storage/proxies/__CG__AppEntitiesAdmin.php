 ...
 */
class Admin extends \App\Entities\Admin implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entities\\Admin' . "\0" . 'id', '' . "\0" . 'App\\Entities\\Admin' . "\0" . 'firstName', '' . "\0" . 'App\\Entities\\Admin' . "\0" . 'lastName', '' . "\0" . 'App\\Entities\\Admin' . "\0" . 'email', '' . "\0" . 'App\\Entities\\Admin' . "\0" . 'contactNumber', '' . "\0" . 'App\\Entities\\Admin' . "\0" . 'profileImage', '' . "\0" . 'App\\Entities\\Admin' . "\0" . 'password', '' . "\0" . 'App\\Entities\\Admin' . "\0" . 'isSuperUser', '' . "\0" . 'App\\Entities\\Admin' . "\0" . 'rememberToken', '' . "\0" . 'App\\Entities\\Admin' . "\0" . 'isActive', '' . "\0" . 'App\\Entities\\Admin' . "\0" . 'createdAt', '' . "\0" . 'App\\Entities\\Admin' . "\0" . 'updatedAt', '' . "\0" . 'App\\Entities\\Admin' . "\0" . 'adminRole'];
        }
     ...
     * {@inheritDoc}
     */
    public function addAdminRole(\App\Entities\AdminRole $adminRoles)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addAdminRole', [$adminRoles]);

        return parent::addAdminRole($adminRoles);
    }
