 ...
 */
class AdminRole extends \App\Entities\AdminRole implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entities\\AdminRole' . "\0" . 'id', '' . "\0" . 'App\\Entities\\AdminRole' . "\0" . 'roleId', '' . "\0" . 'App\\Entities\\AdminRole' . "\0" . 'adminId', '' . "\0" . 'App\\Entities\\AdminRole' . "\0" . 'isActive', '' . "\0" . 'App\\Entities\\AdminRole' . "\0" . 'createdAt', '' . "\0" . 'App\\Entities\\AdminRole' . "\0" . 'updatedAt'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (AdminRole $proxy) {
