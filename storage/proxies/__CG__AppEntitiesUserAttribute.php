 ...
 */
class UserAttribute extends \App\Entities\UserAttribute implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entities\\UserAttribute' . "\0" . 'id', '' . "\0" . 'App\\Entities\\UserAttribute' . "\0" . 'userRole', '' . "\0" . 'App\\Entities\\UserAttribute' . "\0" . 'name', '' . "\0" . 'App\\Entities\\UserAttribute' . "\0" . 'displayName'];
        }
