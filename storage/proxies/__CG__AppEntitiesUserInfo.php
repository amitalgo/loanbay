 ...
 */
class UserInfo extends \App\Entities\UserInfo implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entities\\UserInfo' . "\0" . 'id', '' . "\0" . 'App\\Entities\\UserInfo' . "\0" . 'user', '' . "\0" . 'App\\Entities\\UserInfo' . "\0" . 'key', '' . "\0" . 'App\\Entities\\UserInfo' . "\0" . 'value'];
        }
