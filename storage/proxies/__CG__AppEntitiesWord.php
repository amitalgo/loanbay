...
class Word extends \App\Entities\Word implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entities\\Word' . "\0" . 'id', '' . "\0" . 'App\\Entities\\Word' . "\0" . 'word', '' . "\0" . 'App\\Entities\\Word' . "\0" . 'isActive', 'createdAt', 'updatedAt', '' . "\0" . 'App\\Entities\\Word' . "\0" . 'wordId'];
        }
